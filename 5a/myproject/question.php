...
if(isset($_POST['Submit']) and ($_POST['answer']!="")){
    $path = 'admin/challenge/'.$_GET['id'];
    foreach (new DirectoryIterator($path) as $fileInfo) {
        $a=$fileInfo->getFilename();
    }
    $b=substr($a,0,strlen($a)-4);
    if ($b==$_POST['answer'])
    {
...
<html lang="en">
  ...
  <section id="container" >
      ...
      <section id="main-content">
          ...
          <?php $ret=mysqli_query($con,"select * from challenge where id='".$_GET['id']."'");
                  ...
                  <div class="col-md-12">
                      ...
                      <form class="form-horizontal style-form" name="form1" method="post" action="" onSubmit="return valid();">
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" name="question" value="<?php echo $row['suggest'];?>" readonly>
                              </div>
                          </div>
                          </form>
                      </div>
              ...
              <div class="row">  
                  <div class="col-md-12">
                      <div class="content-panel">
                           <form class="form-horizontal style-form" name="form1" method="post" action="" onSubmit="return valid();">
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label" style="padding-left:40px;"> ĐÁP ÁN CỦA BẠN </label>
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" name="answer" value="" >
                              </div>
                          </div>
                          <div style="margin-left:100px;">
                          <input type="submit" name="Submit" value="TRẢ LỜI" class="btn btn-theme"></div>
                          </form>
                      </div>
                  </div>
              </div>
