                  ...
                  <div class="col-md-12">
                      ...
                      <table class="table table-striped table-advance table-hover">
                              ...
                              <?php for ($i = 0; $i < count($message); $i++) {
                                  if ($message[$i]['id_1']!=Auth::user()->id){
                                  ?>
                              <tr>
                              <td><?php echo $name;?></td>
                                  <td><?php echo $message[$i]['text'];?></td>  
                              </tr>
                              <?php }
                            else
                              {
                                ...
                                <td><?php echo Auth::user()->name;?></td>
                                    <td><?php echo $message[$i]['text'];?></td>
                                    <td>
                                        <a href="/deletemessage<?php echo $message[$i]['id'];?>&<?php echo $message[$i]['id_2'];?>&<?php echo $name;?>"> 
                                    ...
                                    <td>
                                        <a href="/updatemessage<?php echo $message[$i]['id'];?>"> 
