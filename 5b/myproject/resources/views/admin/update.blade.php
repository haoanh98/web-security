  ...
  <section id="container" >
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-star"></i> Thông Tin của <?php  echo $user->name?></h3>
                  ...
                  <div class="col-md-12">
                      <div class="content-panel">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" name="contact" value="<?php  echo $user->contactno;?>" >
                              </div>
                          </div>
				...
				<div class="row">      
                  <div class="col-md-12">
                      <div class="content-panel">
                          ...
                          <div style="margin-left:100px;">
                          <input type="submit" name="Submit1" value="Thay Đổi" class="btn btn-theme"></div>
                          </form>
                      </div>
                  </div>
              </div>
